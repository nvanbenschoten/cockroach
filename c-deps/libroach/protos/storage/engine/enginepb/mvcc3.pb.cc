...
void MVCCStatsDelta::InitAsDefaultInstance() {
  ::cockroach::storage::engine::enginepb::_MVCCStatsDelta_default_instance_._instance.get_mutable()->write_high_watermark_ = const_cast< ::cockroach::util::hlc::Timestamp*>(
      ::cockroach::util::hlc::Timestamp::internal_default_instance());
}
void MVCCStatsDelta::clear_write_high_watermark() {
  if (GetArenaNoVirtual() == NULL && write_high_watermark_ != NULL) {
...
const int MVCCStatsDelta::kWriteHighWatermarkFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
MVCCStatsDelta::MVCCStatsDelta(const MVCCStatsDelta& from)
  ...
  if (from.has_write_high_watermark()) {
    write_high_watermark_ = new ::cockroach::util::hlc::Timestamp(*from.write_high_watermark_);
  } else {
    write_high_watermark_ = NULL;
  }
...
void MVCCStatsDelta::SerializeWithCachedSizes(
  ...
  if (this->has_write_high_watermark()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
...
// @@protoc_insertion_point(class_specific_merge_from_start:cockroach.storage.engine.enginepb.MVCCStatsDelta)
  ...
  if (from.has_write_high_watermark()) {
    mutable_write_high_watermark()->::cockroach::util::hlc::Timestamp::MergeFrom(from.write_high_watermark());
  }
...
void MVCCPersistentStats::InitAsDefaultInstance() {
  ::cockroach::storage::engine::enginepb::_MVCCPersistentStats_default_instance_._instance.get_mutable()->write_high_watermark_ = const_cast< ::cockroach::util::hlc::Timestamp*>(
      ::cockroach::util::hlc::Timestamp::internal_default_instance());
}
void MVCCPersistentStats::clear_write_high_watermark() {
  if (GetArenaNoVirtual() == NULL && write_high_watermark_ != NULL) {
    delete write_high_watermark_;
  }
  write_high_watermark_ = NULL;
...
const int MVCCPersistentStats::kWriteHighWatermarkFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
