...
class Transaction : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.roachpb.Transaction) */ {
 public:
  ...
  void clear_written_intents();
  static const int kWrittenIntentsFieldNumber = 11;
  ::cockroach::roachpb::Span* mutable_written_intents(int index);
  ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::Span >*
      mutable_written_intents();
  const ::cockroach::roachpb::Span& written_intents(int index) const;
  ::cockroach::roachpb::Span* add_written_intents();
  const ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::Span >&
      written_intents() const;
...
inline int Transaction::written_intents_size() const {
  return written_intents_.size();
}
inline void Transaction::clear_written_intents() {
  written_intents_.Clear();
}
inline ::cockroach::roachpb::Span* Transaction::mutable_written_intents(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.roachpb.Transaction.written_intents)
  return written_intents_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::Span >*
Transaction::mutable_written_intents() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.roachpb.Transaction.written_intents)
  return &written_intents_;
}
inline const ::cockroach::roachpb::Span& Transaction::written_intents(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.Transaction.written_intents)
  return written_intents_.Get(index);
}
inline ::cockroach::roachpb::Span* Transaction::add_written_intents() {
  // @@protoc_insertion_point(field_add:cockroach.roachpb.Transaction.written_intents)
  return written_intents_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::Span >&
Transaction::written_intents() const {
  // @@protoc_insertion_point(field_list:cockroach.roachpb.Transaction.written_intents)
  return written_intents_;
}

inline int Transaction::promised_intents_size() const {
  return promised_intents_.size();
}
...
inline int TransactionRecord::written_intents_size() const {
  return written_intents_.size();
}
inline void TransactionRecord::clear_written_intents() {
  written_intents_.Clear();
}
inline ::cockroach::roachpb::Span* TransactionRecord::mutable_written_intents(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.roachpb.TransactionRecord.written_intents)
  return written_intents_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::Span >*
TransactionRecord::mutable_written_intents() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.roachpb.TransactionRecord.written_intents)
  return &written_intents_;
}
inline const ::cockroach::roachpb::Span& TransactionRecord::written_intents(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.TransactionRecord.written_intents)
  return written_intents_.Get(index);
}
inline ::cockroach::roachpb::Span* TransactionRecord::add_written_intents() {
  // @@protoc_insertion_point(field_add:cockroach.roachpb.TransactionRecord.written_intents)
  return written_intents_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::Span >&
TransactionRecord::written_intents() const {
  // @@protoc_insertion_point(field_list:cockroach.roachpb.TransactionRecord.written_intents)
  return written_intents_;
}

inline int TransactionRecord::promised_intents_size() const {
  return promised_intents_.size();
}
