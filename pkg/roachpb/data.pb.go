...
func (ValueType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{0}
}
...
func (ReplicaChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{1}
}
...
func (TransactionStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{2}
}
...
func (*StoreIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{3}
}
...
func (*SplitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{4}
}
...
func (*MergeTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{5}
}
...
func (*ChangeReplicasTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{6}
}
...
func (*ModifiedSpanTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{7}
}
...
func (*InternalCommitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{8}
}
...
func (*ObservedTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{9}
}
...
type Transaction struct {
	...
	// Intents ...
	//
	// A transaction with a COMMITTED status will never have any promised intents. ...
	//
	// TODO DURING REIVEW: I'd like to get this naming right the first time, so
	// I'm happy to bikeshed this. How about stable_intents?
	WrittenIntents  []Span          `protobuf:"bytes,11,rep,name=written_intents,json=writtenIntents,proto3" json:"written_intents"`
	PromisedIntents map[int32]int32 `protobuf:"bytes,17,rep,name=promised_intents,json=promisedIntents,proto3" json:"promised_intents" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{10}
}
...
func (*TransactionRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{11}
}
...
func (*SequencedWrite) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{12}
}
...
// An Intent is a Span together with a Transaction metadata and its status.
type Intent struct {
...
func (*Intent) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{13}
}
...
func (*Lease) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{14}
}
...
func (*AbortSpanEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{15}
}
...
func (*TxnCoordMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_49581641c89656e1, []int{16}
}
...
func init() {
	...
	proto.RegisterMapType((map[int32]int32)(nil), "cockroach.roachpb.Transaction.PromisedIntentsEntry")
	proto.RegisterType((*TransactionRecord)(nil), "cockroach.roachpb.TransactionRecord")
	proto.RegisterMapType((map[int32]int32)(nil), "cockroach.roachpb.TransactionRecord.PromisedIntentsEntry")
...
func NewPopulatedTransaction(r randyData, easy bool) *Transaction {
	...
	if r.Intn(10) != 0 {
		v10 := r.Intn(5)
		this.WrittenIntents = make([]Span, v10)
		for i := 0; i < v10; i++ {
			v11 := NewPopulatedSpan(r, easy)
			this.WrittenIntents[i] = *v11
		}
	}
	...
	if r.Intn(10) != 0 {
		v14 := r.Intn(10)
		this.PromisedIntents = make(map[int32]int32)
		for i := 0; i < v14; i++ {
			v15 := int32(r.Int31())
			this.PromisedIntents[v15] = int32(r.Int31())
			if r.Intn(2) == 0 {
				this.PromisedIntents[v15] *= -1
			}
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedTransactionRecord(r randyData, easy bool) *TransactionRecord {
	...
	if r.Intn(10) != 0 {
		v19 := r.Intn(5)
		this.WrittenIntents = make([]Span, v19)
		for i := 0; i < v19; i++ {
			v20 := NewPopulatedSpan(r, easy)
			this.WrittenIntents[i] = *v20
		}
	}
	if r.Intn(10) != 0 {
		v21 := r.Intn(10)
		...
		for i := 0; i < v21; i++ {
			v22 := int32(r.Int31())
			this.PromisedIntents[v22] = int32(r.Int31())
			if r.Intn(2) == 0 {
				this.PromisedIntents[v22] *= -1
			}
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func init() { proto.RegisterFile("roachpb/data.proto", fileDescriptor_data_49581641c89656e1) }

var fileDescriptor_data_49581641c89656e1 = []byte{
	...
	,
}
