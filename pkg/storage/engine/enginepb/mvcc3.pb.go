...
func (*TxnMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{0}
}
...
type MVCCLock struct {
	...
	IntentHistory []MVCCLock_SequencedIntent `protobuf:"bytes,8,rep,name=intent_history,json=intentHistory,proto3" json:"intent_history"`
}
...
func (*MVCCLock) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{1}
}
...
type MVCCLock_SequencedIntent struct {
	...
	// the IntentHistory.
	Sequence TxnSeq `protobuf:"varint,1,opt,name=sequence,proto3,casttype=TxnSeq" json:"sequence,omitempty"`
	// Value is the value written to the key as part of the transaction at
	// the above Sequence.
	Value []byte `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
}

func (m *MVCCLock_SequencedIntent) Reset()      { *m = MVCCLock_SequencedIntent{} }
func (*MVCCLock_SequencedIntent) ProtoMessage() {}
func (*MVCCLock_SequencedIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{1, 0}
}
func (m *MVCCLock_SequencedIntent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVCCLock_SequencedIntent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *MVCCLock_SequencedIntent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVCCLock_SequencedIntent.Merge(dst, src)
}
func (m *MVCCLock_SequencedIntent) XXX_Size() int {
	return m.Size()
}
func (m *MVCCLock_SequencedIntent) XXX_DiscardUnknown() {
	xxx_messageInfo_MVCCLock_SequencedIntent.DiscardUnknown(m)
}

var xxx_messageInfo_MVCCLock_SequencedIntent proto.InternalMessageInfo
...
func (*MVCCStatsDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{2}
}
...
func (*MVCCPersistentStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{3}
}
...
func (*RangeAppliedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{4}
}
...
func (*MVCCWriteValueOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{5}
}
...
func (*MVCCWriteIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{6}
}
...
func (*MVCCUpdateIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{7}
}
...
func (*MVCCCommitIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{8}
}
...
func (*MVCCAbortIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{9}
}
...
func (*MVCCAbortTxnOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{10}
}
...
func (*MVCCLogicalOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_71ad6da9e3e18eb9, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*MVCCLock)(nil), "cockroach.storage.engine.enginepb.MVCCLock")
	proto.RegisterType((*MVCCLock_SequencedIntent)(nil), "cockroach.storage.engine.enginepb.MVCCLock.SequencedIntent")
...
func (this *MVCCLock) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MVCCLock)
	if !ok {
		that2, ok := that.(MVCCLock)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *MVCCLock_SequencedIntent) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MVCCLock_SequencedIntent)
	if !ok {
		that2, ok := that.(MVCCLock_SequencedIntent)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *MVCCLock) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintMvcc3(dAtA, i, uint64(m.Txn.Size()))
...
func (m *MVCCLock_SequencedIntent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MVCCLock_SequencedIntent) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func NewPopulatedMVCCLock(r randyMvcc3, easy bool) *MVCCLock {
	this := &MVCCLock{}
	v5 := NewPopulatedTxnMeta(r, easy)
	this.Txn = *v5
	if r.Intn(10) != 0 {
		v6 := r.Intn(5)
		this.IntentHistory = make([]MVCCLock_SequencedIntent, v6)
		for i := 0; i < v6; i++ {
			v7 := NewPopulatedMVCCLock_SequencedIntent(r, easy)
			this.IntentHistory[i] = *v7
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedMVCCLock_SequencedIntent(r randyMvcc3, easy bool) *MVCCLock_SequencedIntent {
	this := &MVCCLock_SequencedIntent{}
	this.Sequence = TxnSeq(r.Int31())
	if r.Intn(2) == 0 {
		this.Sequence *= -1
	}
...
func NewPopulatedRangeAppliedState(r randyMvcc3, easy bool) *RangeAppliedState {
	...
	v9 := NewPopulatedMVCCPersistentStats(r, easy)
	this.RangeStats = *v9
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldMvcc3(dAtA []byte, r randyMvcc3, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateMvcc3(dAtA, uint64(v11))
	case 1:
		dAtA = encodeVarintPopulateMvcc3(dAtA, uint64(key))
...
func (m *MVCCLock_SequencedIntent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MVCCLock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.IntentHistory = append(m.IntentHistory, MVCCLock_SequencedIntent{})
...
func (m *MVCCLock_SequencedIntent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func init() {
	proto.RegisterFile("storage/engine/enginepb/mvcc3.proto", fileDescriptor_mvcc3_71ad6da9e3e18eb9)
}

var fileDescriptor_mvcc3_71ad6da9e3e18eb9 = []byte{
	...
	,
}
