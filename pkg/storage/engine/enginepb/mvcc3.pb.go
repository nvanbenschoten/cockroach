...
type MVCCStatsDelta struct {
	...
	WriteHighWatermark cockroach_util_hlc.Timestamp `protobuf:"bytes,15,opt,name=write_high_watermark,json=writeHighWatermark" json:"write_high_watermark"`
}
...
func (this *MVCCStatsDelta) Equal(that interface{}) bool {
	...
	if !this.WriteHighWatermark.Equal(&that1.WriteHighWatermark) {
		return false
	}
	return true
}
...
func (m *MVCCStatsDelta) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x7a
	i++
	i = encodeVarintMvcc3(dAtA, i, uint64(m.WriteHighWatermark.Size()))
	n3, err := m.WriteHighWatermark.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
...
func (m *MVCCPersistentStats) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintMvcc3(dAtA, i, uint64(m.WriteHighWatermark.Size()))
	n4, err := m.WriteHighWatermark.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (m *MVCCStatsDelta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WriteHighWatermark", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.WriteHighWatermark.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorMvcc3 = []byte{
	...
	,
}
