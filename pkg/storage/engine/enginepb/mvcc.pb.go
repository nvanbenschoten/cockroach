...
type FixedTimestamp struct {
	...
	// nanoseconds.
	WallTime int64 `protobuf:"fixed64,1,opt,name=wall_time,json=wallTime" json:"wall_time"`
	// The logical component captures causality for events whose wall
	// times are equal. It is effectively bounded by (maximum clock
	// skew)/(minimal ns between events) and nearly impossible to
	// overflow.
	Logical int32 `protobuf:"fixed32,2,opt,name=logical" json:"logical"`
}

func (m *FixedTimestamp) Reset()                    { *m = FixedTimestamp{} }
func (m *FixedTimestamp) String() string            { return proto.CompactTextString(m) }
func (*FixedTimestamp) ProtoMessage()               {}
func (*FixedTimestamp) Descriptor() ([]byte, []int) { return fileDescriptorMvcc, []int{1} }
...
type MVCCStats struct {
	...
	// write_high_watermark is the upper bound timestamp of all live
	// values. The value will never recess.
	WriteHighWatermark FixedTimestamp `protobuf:"bytes,15,opt,name=write_high_watermark,json=writeHighWatermark" json:"write_high_watermark"`
}
...
func init() {
	...
	proto.RegisterType((*FixedTimestamp)(nil), "cockroach.storage.engine.enginepb.FixedTimestamp")
	proto.RegisterType((*MVCCStats)(nil), "cockroach.storage.engine.enginepb.MVCCStats")
}
func (this *FixedTimestamp) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*FixedTimestamp)
	if !ok {
		that2, ok := that.(FixedTimestamp)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *FixedTimestamp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *FixedTimestamp) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0x9
	i++
	binary.LittleEndian.PutUint64(dAtA[i:], uint64(m.WallTime))
	i += 8
	dAtA[i] = 0x15
	i++
	binary.LittleEndian.PutUint32(dAtA[i:], uint32(m.Logical))
	i += 4
	return i, nil
}
...
func (m *MVCCStats) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x7a
	i++
	i = encodeVarintMvcc(dAtA, i, uint64(m.WriteHighWatermark.Size()))
...
func NewPopulatedFixedTimestamp(r randyMvcc, easy bool) *FixedTimestamp {
	this := &FixedTimestamp{}
...
func NewPopulatedMVCCStats(r randyMvcc, easy bool) *MVCCStats {
	...
	v3 := NewPopulatedFixedTimestamp(r, easy)
	this.WriteHighWatermark = *v3
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func randFieldMvcc(dAtA []byte, r randyMvcc, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateMvcc(dAtA, uint64(v5))
	case 1:
		dAtA = encodeVarintPopulateMvcc(dAtA, uint64(key))
...
func (m *FixedTimestamp) Size() (n int) {
	var l int
	_ = l
	n += 9
	n += 5
...
func (m *FixedTimestamp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FixedTimestamp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FixedTimestamp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 1 {
			...
			m.WallTime = int64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		case 2:
			if wireType != 5 {
			...
			m.Logical = int32(binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
		default:
			iNdEx = preIndex
			skippy, err := skipMvcc(dAtA[iNdEx:])
...
var fileDescriptorMvcc = []byte{
	...
	,
}
