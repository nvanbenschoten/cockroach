...
func (*MVCCMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_ed5ccd8ff09c0899, []int{0}
}
...
func (*MVCCStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_ed5ccd8ff09c0899, []int{1}
}
...
func (m *MVCCMetadata) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MergeTimestamp != nil {
		...
		n2, err := m.MergeTimestamp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func init() {
	proto.RegisterFile("storage/engine/enginepb/mvcc.proto", fileDescriptor_mvcc_ed5ccd8ff09c0899)
}

var fileDescriptor_mvcc_ed5ccd8ff09c0899 = []byte{
	// 558 bytes of a gzipped FileDescriptorProto
	,
}
