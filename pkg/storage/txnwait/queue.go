...
func (q *Queue) MaybeWaitForPush(ctx context.Context, req *roachpb.PushTxnRequest) *roachpb.Error {
...
func (q *Queue) MaybeWaitForQuery(ctx context.Context, req *roachpb.QueryTxnRequest) *roachpb.Error {
...
// transactions.
func (q *Queue) forcePushAbort(ctx context.Context, req *roachpb.PushTxnRequest) *roachpb.Error {
