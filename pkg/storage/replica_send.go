...
// responsibility of releasing the concurrency guard it was provided.
...
func (r *Replica) executeBatchWithConcurrencyRetries(
	...
	for {
		...
		var async bool
		br, async, pErr = fn(r, ctx, ba, latchSpans, g)
...
func (r *Replica) collectSpans(
	...
	for _, s := range [2]*spanset.SpanSet{latchSpans, lockSpans} {
		s.SortAndDedup()
