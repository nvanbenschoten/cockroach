...
func newAllOperationsConfig() GeneratorConfig {
	clientOpConfig := ClientOperationConfig{
		...
		GetMissingForUpdateGuaranteedDurability:           10,
		GetMissingForUpdateSkipLocked:                     0,
		GetMissingForUpdateSkipLockedGuaranteedDurability: 0,
		GetMissingForShare:                                1,
		GetMissingForShareGuaranteedDurability:            10,
		GetMissingForShareSkipLocked:                      0,
		GetMissingForShareSkipLockedGuaranteedDurability:  0,
		GetExisting:                                        1,
		GetExistingForUpdate:                               1,
		GetExistingForUpdateGuaranteedDurability:           10,
		GetExistingForShare:                                1,
		GetExistingForShareGuaranteedDurability:            10,
		GetExistingSkipLocked:                              0,
		GetExistingForUpdateSkipLocked:                     0,
		GetExistingForUpdateSkipLockedGuaranteedDurability: 0,
		GetExistingForShareSkipLocked:                      0,
		GetExistingForShareSkipLockedGuaranteedDurability:  0,
		PutMissing:                        1,
		PutExisting:                       1,
		Scan:                              1,
		ScanForUpdate:                     1,
		ScanForUpdateGuaranteedDurability: 10,
		ScanForShare:                      1,
		ScanForShareGuaranteedDurability:  10,
		ScanSkipLocked:                    0,
		ScanForUpdateSkipLocked:           0,
		ScanForUpdateSkipLockedGuaranteedDurability: 0,
		ScanForShareSkipLocked:                      0,
		ScanForShareSkipLockedGuaranteedDurability:  0,
		ReverseScan:                                        1,
		ReverseScanForUpdate:                               1,
		ReverseScanForUpdateGuaranteedDurability:           10,
		ReverseScanForShare:                                1,
		ReverseScanForShareGuaranteedDurability:            10,
		ReverseScanSkipLocked:                              0,
		ReverseScanForUpdateSkipLocked:                     0,
		ReverseScanForUpdateSkipLockedGuaranteedDurability: 0,
		ReverseScanForShareSkipLocked:                      0,
		ReverseScanForShareSkipLockedGuaranteedDurability:  0,
		DeleteMissing:                                      1,
		DeleteExisting:                                     1,
		DeleteRange:                                        1,
