...
func newAllOperationsConfig() GeneratorConfig {
	clientOpConfig := ClientOperationConfig{
		...
		GetMissingForUpdateSkipLockedGuaranteedDurability: 10,
		GetMissingForShare:                                1,
		GetMissingForShareGuaranteedDurability:            10,
		GetMissingForShareSkipLocked:                      1,
		GetMissingForShareSkipLockedGuaranteedDurability:  10,
		GetExisting:                                        1,
		...
		GetExistingForUpdateSkipLockedGuaranteedDurability: 10,
		GetExistingForShareSkipLocked:                      1,
		GetExistingForShareSkipLockedGuaranteedDurability:  10,
		PutMissing:                        1,
		PutExisting:                       1,
		Scan:                              1,
		ScanForUpdate:                     1,
		...
		ScanForUpdateSkipLockedGuaranteedDurability: 10,
		ScanForShareSkipLocked:                      1,
		ScanForShareSkipLockedGuaranteedDurability:  10,
		ReverseScan:                                        1,
		...
		ReverseScanForUpdateSkipLockedGuaranteedDurability: 10,
		ReverseScanForShareSkipLocked:                      1,
		ReverseScanForShareSkipLockedGuaranteedDurability:  10,
		DeleteMissing:                                      1,
		DeleteExisting:                                     1,
		DeleteRange:                                        1,
